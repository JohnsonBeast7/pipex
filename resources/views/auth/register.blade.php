    ...
    <div class="flex flex-col items-center w-full max-w-[1072px] px-6 m-auto py-20">
        <div class="flex flex-col gap-4 items-center w-full max-w-[512px] bg-gray-800 shadow-md py-10 px-6">
            <div class="flex flex-row items-center gap-1">
                <h2 class="text-white text-3xl font-semibold">Registro</h2>
            ...
            <form action="{{ route('registerSubmit') }}" method="POST" class="flex flex-col gap-6 w-full max-w-[75%]">
                ...
                <div class="flex flex-col gap-2 items-center">
                    <button type="submit" class="bg-sky-500 hover:bg-sky-600 transition duration-300 text-white font-semibold w-full max-w-fit m-auto py-2 px-6 rounded-lg">Registrar</button>
                    <p class="text-white">ou <a href="{{ route('login') }}" class="text-sky-500 hover:text-sky-600 transition duration-300 font-semibold">Entrar</a></p>
                </div>
            </form>
        </div>
    </div>
